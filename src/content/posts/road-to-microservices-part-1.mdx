...
<figure className="flex flex-col items-center w-full">
  <img
    src="/road-to-microservices-part-1/click_cart_simplified.png"
    alt="Simplified Model of ClickCart Monolithic Application"
    width="600"
...
<figure className="flex flex-col items-center w-full">
  <img
    src="/road-to-microservices-part-1/click_cart_strangler_fig_pattern.png"
    alt="Strangler Fig Pattern for ClickCart"
    width="900"
    className="border bg-white border-gray-200 dark:border-gray-700 shadow-md transition-transform duration-200 hover:scale-[1.02] p-6"
  />
  <figcaption className="text-sm text-gray-500 dark:text-gray-400 mt-1 text-center">
...
<figure className="flex flex-col items-center w-full">
  <img
    src="/road-to-microservices-part-1/click_cart_ui_composition.png"
    alt="UI Composition Pattern for ClickCart"
    width="1000"
    className="border bg-white border-gray-200 dark:border-gray-700 shadow-md transition-transform duration-200 hover:scale-[1.02] p-6"
  />
  <figcaption className="text-sm text-gray-500 dark:text-gray-400 mt-1 text-center">
...
<figure className="flex flex-col items-center w-full">
  <img
    src="/road-to-microservices-part-1/click_cart_branch_by_abstraction.png"
    alt="Branch by Abstraction Pattern for ClickCart"
    width="700"
    className="border bg-white border-gray-200 dark:border-gray-700 shadow-md transition-transform duration-200 hover:scale-[1.02] p-6"
  />
  <figcaption className="text-sm text-gray-500 dark:text-gray-400 mt-1 text-center">
...
<figure className="flex flex-col items-center w-full">
  <img
    src="/road-to-microservices-part-1/click_cart_parallel_run.png"
    alt="Parallel Run Pattern for ClickCart"
    width="400"
    className="border bg-white border-gray-200 dark:border-gray-700 shadow-md transition-transform duration-200 hover:scale-[1.02] p-6"
  />
  <figcaption className="text-sm text-gray-500 dark:text-gray-400 mt-1 text-center">
...
<figure className="flex flex-col items-center w-full">
  <img
    src="/road-to-microservices-part-1/click_cart_decorating_collaborator.png"
    alt="Decorating Collaborator Pattern for ClickCart"
    width="500"
    className="border bg-white border-gray-200 dark:border-gray-700 shadow-md transition-transform duration-200 hover:scale-[1.02] p-6"
  />
  <figcaption className="text-sm text-gray-500 dark:text-gray-400 mt-1 text-center">
...
<figure className="flex flex-col items-center w-full">
  <img
    src="/road-to-microservices-part-1/click_cart_database_triggers.png"
    alt="Database Triggers for ClickCart"
    width="500"
    className="border bg-white border-gray-200 dark:border-gray-700 shadow-md transition-transform duration-200 hover:scale-[1.02] p-6"
  />
  <figcaption className="text-sm text-gray-500 dark:text-gray-400 mt-1 text-center">
...
<figure className="flex flex-col items-center w-full">
  <img
    src="/road-to-microservices-part-1/click_cart_transaction_log_pollers.png"
    alt="Transaction Log Pollers for ClickCart"
    width="500"
    className="border bg-white border-gray-200 dark:border-gray-700 shadow-md transition-transform duration-200 hover:scale-[1.02] p-6"
  />
  <figcaption className="text-sm text-gray-500 dark:text-gray-400 mt-1 text-center">
...
<figure className="flex flex-col items-center w-full">
  <img
    src="/road-to-microservices-part-1/click_cart_shared_database.png"
    alt="Shared Database for ClickCart"
    width="700"
    className="border bg-white border-gray-200 dark:border-gray-700 shadow-md transition-transform duration-200 hover:scale-[1.02] p-6"
  />
  <figcaption className="text-sm text-gray-500 dark:text-gray-400 mt-1 text-center">
...
<figure className="flex flex-col items-center w-full">
  <img
    src="/road-to-microservices-part-1/click_cart_database_view.png"
    alt="Database View for ClickCart"
    width="700"
    className="border bg-white border-gray-200 dark:border-gray-700 shadow-md transition-transform duration-200 hover:scale-[1.02] p-6"
  />
  <figcaption className="text-sm text-gray-500 dark:text-gray-400 mt-1 text-center">
...
<figure className="flex flex-col items-center w-full">
  <img
    src="/road-to-microservices-part-1/click_cart_database_wrapping_service.png"
    alt="Database Wrapping Service for ClickCart"
    width="800"
    className="border bg-white border-gray-200 dark:border-gray-700 shadow-md transition-transform duration-200 hover:scale-[1.02] p-6"
  />
  <figcaption className="text-sm text-gray-500 dark:text-gray-400 mt-1 text-center">
...
<figure className="flex flex-col items-center w-full">
  <img
    src="/road-to-microservices-part-1/click_cart_database_as_a_service_interface.png"
    alt="Database as a Service Interface for ClickCart"
    width="700"
    className="border bg-white border-gray-200 dark:border-gray-700 shadow-md transition-transform duration-200 hover:scale-[1.02] p-6"
  />
  <figcaption className="text-sm text-gray-500 dark:text-gray-400 mt-1 text-center">
...
<figure className="flex flex-col items-center w-full">
  <img
    src="/road-to-microservices-part-1/click_cart_aggregate_exposing_monolith.png"
    alt="Database as a Service Interface for ClickCart"
    width="600"
    className="border bg-white border-gray-200 dark:border-gray-700 shadow-md transition-transform duration-200 hover:scale-[1.02] p-6"
  />
...
<figure className="flex flex-col items-center w-full">
  <img
    src="/road-to-microservices-part-1/click_cart_change_data_ownership.png"
    alt="Change Data Ownership for ClickCart"
    width="700"
    className="border bg-white border-gray-200 dark:border-gray-700 shadow-md transition-transform duration-200 hover:scale-[1.02] p-6"
  />
  <figcaption className="text-sm text-gray-500 dark:text-gray-400 mt-1 text-center">
...
<figure className="flex flex-col items-center w-full">
  <img
    src="/road-to-microservices-part-1/click_cart_synchronize_data.png"
    alt="Synchronize Data for ClickCart"
    width="600"
    className="border bg-white border-gray-200 dark:border-gray-700 shadow-md transition-transform duration-200 hover:scale-[1.02] p-6"
  />
  <figcaption className="text-sm text-gray-500 dark:text-gray-400 mt-1 text-center">
...
<figure className="flex flex-col items-center w-full">
  <img
    src="/road-to-microservices-part-1/click_cart_tracer_write.png"
    alt="Tracer Write for ClickCart"
    width="500"
    className="border bg-white border-gray-200 dark:border-gray-700 shadow-md transition-transform duration-200 hover:scale-[1.02] p-6"
  />
  <figcaption className="text-sm text-gray-500 dark:text-gray-400 mt-1 text-center">
