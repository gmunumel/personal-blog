...
<figure className="flex flex-col items-center w-full">
  <img
    src="/clean-architecture-python-part-1/clean_architecture.png"
    alt="Diagram Clean Architecture"
    width="400"
...
source code dependencies must point inward, toward the higher-level policies and the **_Dependency Inversion Principle (DIP)_**.
...
without any knowledge of the external systems, allowing us to use **_Domain-Driven Design (DDD)_** approach
if desired.

### Hexagonal Architecture

Hexagonal Architecture, also known as **_Ports and Adapters_**, was introduced by Alistair Cockburn
...
<figure className="flex flex-col items-center w-full">
  <img
    src="/clean-architecture-python-part-1/hexagonal_architecture.png"
    alt="Diagram Hexagonal Architecture"
    width="700"
    className="border bg-white border-gray-200 dark:border-gray-700 shadow-md transition-transform duration-200 hover:scale-[1.02] p-6"
  />
  <figcaption className="text-sm text-gray-500 dark:text-gray-400 mt-1 text-center">
...
<figure className="flex flex-col items-center w-full">
  <img
    src="/clean-architecture-python-part-1/onion_architecture.png"
    alt="Diagram Onion Architecture"
    width="500"
    className="border bg-white border-gray-200 dark:border-gray-700 shadow-md transition-transform duration-200 hover:scale-[1.02] p-6"
  />
  <figcaption className="text-sm text-gray-500 dark:text-gray-400 mt-1 text-center">
...
<figure className="flex flex-col items-center w-full">
  <img
    src="/clean-architecture-python-part-1/dependency_inversion.png"
    alt="Comparison Domain Layered Architecture without and with Dependency Inversion"
    width="800"
    className="border bg-white border-gray-200 dark:border-gray-700 shadow-md transition-transform duration-200 hover:scale-[1.02] p-6"
  />
  <figcaption className="text-sm text-gray-500 dark:text-gray-400 mt-1 text-center">
