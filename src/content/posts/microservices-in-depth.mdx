...
<figure className="flex flex-col items-center w-full">
  <img
    src="/microservices-in-depth/click_cart.png"
    alt="Overview of the ClickCart Model"
    width="1000"
...
<figure className="flex flex-col items-center w-full">
  <img
    src="/microservices-in-depth/click_cart_monolithic.png"
    alt="Monolithic ClickCart Architecture"
    width="700"
    className="border bg-white border-gray-200 dark:border-gray-700 shadow-md transition-transform duration-200 hover:scale-[1.02] p-6"
  />
  <figcaption className="text-sm text-gray-500 dark:text-gray-400 mt-1 text-center">
...
<figure className="flex flex-col items-center w-full">
  <img
    src="/microservices-in-depth/click_cart_microservices.png"
    alt="Microservices ClickCart Architecture"
    width="700"
    className="border bg-white border-gray-200 dark:border-gray-700 shadow-md transition-transform duration-200 hover:scale-[1.02] p-6"
  />
  <figcaption className="text-sm text-gray-500 dark:text-gray-400 mt-1 text-center">
...
<figure className="flex flex-col items-center w-full">
  <img
    src="/microservices-in-depth/click_cart_holistic.png"
    alt="Holistic View of an Application"
    width="700"
    className="border bg-white border-gray-200 dark:border-gray-700 shadow-md transition-transform duration-200 hover:scale-[1.02] p-6"
  />
  <figcaption className="text-sm text-gray-500 dark:text-gray-400 mt-1 text-center">
...
a specific business function and can be developed, deployed, and scaled independently.
...
<figure className="flex flex-col items-center w-full">
  <img
    src="/microservices-in-depth/click_cart_ci_cd.png"
    alt="Continuous Integration and Deployment Pipeline for ClickCart"
    width="700"
    className="border bg-white border-gray-200 dark:border-gray-700 shadow-md transition-transform duration-200 hover:scale-[1.02] p-6"
  />
  <figcaption className="text-sm text-gray-500 dark:text-gray-400 mt-1 text-center">
...
<figure className="flex flex-col items-center w-full">
  <img
    src="/microservices-in-depth/click_cart_split_db.png"
    alt="Splitting the Database in ClickCart"
    width="700"
    className="border bg-white border-gray-200 dark:border-gray-700 shadow-md transition-transform duration-200 hover:scale-[1.02] p-6"
  />
  <figcaption className="text-sm text-gray-500 dark:text-gray-400 mt-1 text-center">
...
<figure className="flex flex-col items-center w-full">
  <img
    src="/microservices-in-depth/click_cart_data_pump.png"
    alt="Data Pump for ClickCart"
    width="500"
    className="border bg-white border-gray-200 dark:border-gray-700 shadow-md transition-transform duration-200 hover:scale-[1.02] p-6"
  />
  <figcaption className="text-sm text-gray-500 dark:text-gray-400 mt-1 text-center">
...
<figure className="flex flex-col items-center w-full">
  <img
    src="/microservices-in-depth/click_cart_data_orchestration_vs_choreography.png"
    alt="Orchestration vs Choreography for ClickCart"
    width="700"
    className="border bg-white border-gray-200 dark:border-gray-700 shadow-md transition-transform duration-200 hover:scale-[1.02] p-6"
  />
  <figcaption className="text-sm text-gray-500 dark:text-gray-400 mt-1 text-center">
...
<figure className="flex flex-col items-center w-full">
  <img
    src="/microservices-in-depth/click_cart_different_endpoints.png"
    alt="Different Versioning Endpoints for ClickCart"
    width="500"
    className="border bg-white border-gray-200 dark:border-gray-700 shadow-md transition-transform duration-200 hover:scale-[1.02] p-6"
  />
  <figcaption className="text-sm text-gray-500 dark:text-gray-400 mt-1 text-center">
...
<figure className="flex flex-col items-center w-full">
  <img
    src="/microservices-in-depth/click_docker_containers.png"
    alt="Docker Containers for ClickCart"
    width="300"
    className="border bg-white border-gray-200 dark:border-gray-700 shadow-md transition-transform duration-200 hover:scale-[1.02] p-6"
  />
  <figcaption className="text-sm text-gray-500 dark:text-gray-400 mt-1 text-center">
...
<figure className="flex flex-col items-center w-full">
  <img
    src="/microservices-in-depth/click_cart_blue_green_deployment.png"
    alt="Blue/Green Deployment for ClickCart"
    width="700"
    className="border bg-white border-gray-200 dark:border-gray-700 shadow-md transition-transform duration-200 hover:scale-[1.02] p-6"
  />
  <figcaption className="text-sm text-gray-500 dark:text-gray-400 mt-1 text-center">
...
<figure className="flex flex-col items-center w-full">
  <img
    src="/microservices-in-depth/click_cart_elk.png"
    alt="Aggregated Logs using ELK for ClickCart"
    width="600"
    className="border bg-white border-gray-200 dark:border-gray-700 shadow-md transition-transform duration-200 hover:scale-[1.02] p-6"
  />
  <figcaption className="text-sm text-gray-500 dark:text-gray-400 mt-1 text-center">
...
<figure className="flex flex-col items-center w-full">
  <img
    src="/microservices-in-depth/click_cart_correlation_ids.png"
    alt="Correlation IDs for ClickCart"
    width="400"
    className="border bg-white border-gray-200 dark:border-gray-700 shadow-md transition-transform duration-200 hover:scale-[1.02] p-6"
  />
  <figcaption className="text-sm text-gray-500 dark:text-gray-400 mt-1 text-center">
