...
The implementation follows **Domain-Driven Design (DDD)** principles, where the core business logic is separated from the infrastructure concerns.
...
<figure className="article-figure flex flex-col items-center">
  ![Overview of the Clean Buckpal
  Architecture](/clean-architecture-python-part-2/clean_buckpal_overview.png)
  <div>
