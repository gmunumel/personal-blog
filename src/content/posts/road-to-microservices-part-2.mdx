...
<figure className="flex flex-col items-center w-full">
  <img
    src="/road-to-microservices-part-2/click_cart_physical_logical_database.png"
    alt="Physical and Logical Database Separation for ClickCart"
    width="600"
...
<figure className="flex flex-col items-center w-full">
  <img
    src="/road-to-microservices-part-2/click_cart_repository_per_bounded_context.png"
    alt="Repository per Bounded Context for ClickCart"
    width="800"
    className="border bg-white border-gray-200 dark:border-gray-700 shadow-md transition-transform duration-200 hover:scale-[1.02] p-6"
  />
  <figcaption className="text-sm text-gray-500 dark:text-gray-400 mt-1 text-center">
...
<figure className="flex flex-col items-center w-full">
  <img
    src="/road-to-microservices-part-2/click_cart_database_per_bounded_context.png"
    alt="Database per Bounded Context for ClickCart"
    width="800"
    className="border bg-white border-gray-200 dark:border-gray-700 shadow-md transition-transform duration-200 hover:scale-[1.02] p-6"
  />
  <figcaption className="text-sm text-gray-500 dark:text-gray-400 mt-1 text-center">
...
<figure className="flex flex-col items-center w-full">
  <img
    src="/road-to-microservices-part-2/click_cart_multi_schema_storage.png"
    alt="Multi-schema Storage for ClickCart"
    width="600"
    className="border bg-white border-gray-200 dark:border-gray-700 shadow-md transition-transform duration-200 hover:scale-[1.02] p-6"
  />
  <figcaption className="text-sm text-gray-500 dark:text-gray-400 mt-1 text-center">
...
<figure className="flex flex-col items-center w-full">
  <img
    src="/road-to-microservices-part-2/click_cart_split_table.png"
    alt="Split Table for ClickCart"
    width="700"
    className="border bg-white border-gray-200 dark:border-gray-700 shadow-md transition-transform duration-200 hover:scale-[1.02] p-6"
  />
  <figcaption className="text-sm text-gray-500 dark:text-gray-400 mt-1 text-center">
...
<figure className="flex flex-col items-center w-full">
  <img
    src="/road-to-microservices-part-2/click_cart_split_table_same_column.png"
    alt="Split Table with same column Key for ClickCart"
    width="400"
    className="border bg-white border-gray-200 dark:border-gray-700 shadow-md transition-transform duration-200 hover:scale-[1.02] p-6"
  />
  <figcaption className="text-sm text-gray-500 dark:text-gray-400 mt-1 text-center">
...
<figure className="flex flex-col items-center w-full">
  <img
    src="/road-to-microservices-part-2/click_cart_move_foreign_key_relationship.png"
    alt="Move Foreign-key Relationship for ClickCart"
    width="700"
    className="border bg-white border-gray-200 dark:border-gray-700 shadow-md transition-transform duration-200 hover:scale-[1.02] p-6"
  />
  <figcaption className="text-sm text-gray-500 dark:text-gray-400 mt-1 text-center">
...
<figure className="flex flex-col items-center w-full">
  <img
    src="/road-to-microservices-part-2/click_cart_duplicate_static_reference.png"
    alt="Duplicate Static Reference for ClickCart"
    width="500"
    className="border bg-white border-gray-200 dark:border-gray-700 shadow-md transition-transform duration-200 hover:scale-[1.02] p-6"
  />
  <figcaption className="text-sm text-gray-500 dark:text-gray-400 mt-1 text-center">
...
<figure className="flex flex-col items-center w-full">
  <img
    src="/road-to-microservices-part-2/click_cart_dedicated_reference_data.png"
    alt="Dedicated Reference Data for ClickCart"
    width="500"
    className="border bg-white border-gray-200 dark:border-gray-700 shadow-md transition-transform duration-200 hover:scale-[1.02] p-6"
  />
  <figcaption className="text-sm text-gray-500 dark:text-gray-400 mt-1 text-center">
...
<figure className="flex flex-col items-center w-full">
  <img
    src="/road-to-microservices-part-2/click_cart_static_reference_data_library.png"
    alt="Static Reference Data Library for ClickCart"
    width="400"
    className="border bg-white border-gray-200 dark:border-gray-700 shadow-md transition-transform duration-200 hover:scale-[1.02] p-6"
  />
  <figcaption className="text-sm text-gray-500 dark:text-gray-400 mt-1 text-center">
...
<figure className="flex flex-col items-center w-full">
  <img
    src="/road-to-microservices-part-2/click_cart_static_reference_data_service.png"
    alt="Static Reference Data Service for ClickCart"
    width="400"
    className="border bg-white border-gray-200 dark:border-gray-700 shadow-md transition-transform duration-200 hover:scale-[1.02] p-6"
  />
  <figcaption className="text-sm text-gray-500 dark:text-gray-400 mt-1 text-center">
...
<figure className="flex flex-col items-center w-full">
  <img
    src="/road-to-microservices-part-2/click_cart_database_transaction.png"
    alt="Database Transaction for Microservice Architecture in ClickCart"
    width="700"
    className="border bg-white border-gray-200 dark:border-gray-700 shadow-md transition-transform duration-200 hover:scale-[1.02] p-6"
  />
  <figcaption className="text-sm text-gray-500 dark:text-gray-400 mt-1 text-center">
...
<figure className="flex flex-col items-center w-full">
  <img
    src="/road-to-microservices-part-2/click_cart_two_phase_commit.png"
    alt="Two-Phase Commit for Microservice Architecture in ClickCart"
    width="800"
    className="border bg-white border-gray-200 dark:border-gray-700 shadow-md transition-transform duration-200 hover:scale-[1.02] p-6"
  />
  <figcaption className="text-sm text-gray-500 dark:text-gray-400 mt-1 text-center">
...
<figure className="flex flex-col items-center w-full">
  <img
    src="/road-to-microservices-part-2/click_cart_orchestration_sagas.png"
    alt="Orchestration Sagas for Microservice Architecture in ClickCart"
    width="600"
    className="border bg-white border-gray-200 dark:border-gray-700 shadow-md transition-transform duration-200 hover:scale-[1.02] p-6"
  />
  <figcaption className="text-sm text-gray-500 dark:text-gray-400 mt-1 text-center">
...
<figure className="flex flex-col items-center w-full">
  <img
    src="/road-to-microservices-part-2/click_cart_choreography_sagas.png"
    alt="Choreography Sagas for Microservice Architecture in ClickCart"
    width="500"
    className="border bg-white border-gray-200 dark:border-gray-700 shadow-md transition-transform duration-200 hover:scale-[1.02] p-6"
  />
  <figcaption className="text-sm text-gray-500 dark:text-gray-400 mt-1 text-center">
